...
public class Main {
    ...
    private static String promptForCountry(Translator translator) {
        ...
        for (String country : countries) {
            CountryCodeConverter mycconvertor = new CountryCodeConverter();
            String countryname = mycconvertor.fromCountryCode(country);
    ...
    private static String promptForLanguage(Translator translator, String country) {
        ...
        List<String> languageids = translator.getCountryLanguages(country);
        for (String languageid : languageids) {
            LanguageCodeConverter myLconvertor = new LanguageCodeConverter();
            String languagename = myLconvertor.fromLanguageCode(languageid);
